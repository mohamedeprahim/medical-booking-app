      ...
      <section className="bg-gradient-to-br from-teal-600 via-teal-700 to-emerald-800 text-white">
        <div className="max-w-7xl mx-auto px-6 py-24">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-teal-200 font-bold text-sm tracking-widest mb-4">
              ...
              <p className="text-teal-100 text-lg leading-8 max-w-xl mb-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  to="/doctors"
                  className="bg-white text-teal-700 px-7 py-4 rounded-xl font-bold hover:bg-teal-50 transition"
                >
                  Find a Doctor
                </Link>
                ...
                <Link
                  to="/my-appointments"
                  className="border border-teal-300 text-white px-7 py-4 rounded-xl font-bold hover:bg-white/10 transition"
                >
                  My Appointments
                </Link>
      ...
      <section className="py-20">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-teal-600 font-bold text-sm tracking-widest mb-3">
              WHY MEDIBOOK
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-lg transition">
              ...
              <div className="w-14 h-14 rounded-xl bg-teal-100 flex items-center justify-center text-2xl mb-6">
                👨‍⚕️
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-lg transition">
              ...
              <div className="w-14 h-14 rounded-xl bg-emerald-100 flex items-center justify-center text-2xl mb-6">
                📅
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-lg transition">
              ...
              <div className="w-14 h-14 rounded-xl bg-cyan-100 flex items-center justify-center text-2xl mb-6">
                💾
              </div>
      ...
      <section className="pb-20">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-gray-900 rounded-3xl p-10 md:p-14 text-center">
            ...
            <Link
              to="/doctors"
              className="inline-block bg-teal-600 hover:bg-teal-700 text-white px-8 py-4 rounded-xl font-bold transition"
            >
              Browse Doctors
            </Link>
